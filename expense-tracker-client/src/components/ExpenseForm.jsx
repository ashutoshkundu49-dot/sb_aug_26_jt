...
const ExpenseForm=()=>{
    return(
        <div className='bg-white rounded-2xl shadow-md p-6 mb-6'>
            <h2 className='text-xl font-semibold text-gray-700 mb-4'>Add Expenses</h2>
        <form action="#" className='grid grid-cols-1 md:grid-cols-2 gap-4 '>
            <div>
                ...
                <input type="text" className='border w-full border-gray-300 rounded-lg px-3 py-2 focous:outline-none focus:border-blue-500' />
            </div>

            <div>
                <label htmlFor="" className='block font-medium text-gray-600 mb-1'>Category</label>
                <select name="" id="" className='border w-full border-gray-300 rounded-lg px-3 py-2 focous:outline-none focus:border-blue-500'>
               ...
               <div>
                ...
                <input type="date" className='border w-full border-gray-300 rounded-lg px-3 py-2 focous:outline-none focus:border-blue-500' />
            </div>
